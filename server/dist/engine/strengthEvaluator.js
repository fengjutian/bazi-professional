...
exports.evaluateStrength = evaluateStrength;
const elements_1 = require("./elements");
function evaluateStrength(bazi) {
    const dayGanElement = elements_1.GAN_ELEMENTS[bazi.day.gan];
    let score = 0;
    // 计算各柱对日主的帮扶力度
...
// 判断是否为帮扶元素
function isSupportElement(element, targetElement) {
    const supportMap = {
        '木': ['水'],
        '火': ['木'],
        '土': ['火'],
...
// 判断是否为削弱元素
function isWeakeningElement(element, targetElement) {
    const weakenMap = {
        '木': ['金', '土'],
        '火': ['水', '金'],
        '土': ['木', '水'],
